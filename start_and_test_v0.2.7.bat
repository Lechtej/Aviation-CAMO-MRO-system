...
REM ============================================================
REM Aviation CAMO/MRO - One-click start + smoke test (v0.2.7)
...
echo.
echo [6/6] Calling /v1/tenants with Bearer token...
